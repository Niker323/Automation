Shader "Custom/Grid"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void BlockAnim(inout float2 uv, float frames)
            {
                //_Time
                uint animdata = asuint(frames);
                float nowframe = fmod(floor(_Time.y * (animdata >> 8)), (animdata & 255));
                uv.x += (1 / _AtlasSize.x) * nowframe;
            }
